    ...
    >
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center text-white max-w-4xl px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Destapaciones en Zona Sur</h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-200">
            Servicios de destapación de cañerías, tuberías, desagües, cloacas pluviales, rejillas, lavaderos y baños
          </p>
