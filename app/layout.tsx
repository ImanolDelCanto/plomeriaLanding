...
export const metadata: Metadata = {
  title: "Destapaciones y Plomerías | Servicio 24hs CABA y GBA | DestapacionesPlomero.com",
  description:
    "Destapaciones y plomería 24hs en CABA y Gran Buenos Aires. Servicio inmediato, equipos profesionales, garantía de trabajo. Llamá ya!",
  keywords: [
    "destapaciones",
    "plomero",
    "destapacionesplomero",
    "destapaciones caba",
    "plomería buenos aires",
  ...
  openGraph: {
    ...
    siteName: "Destapaciones y Plomerías",
    title: "Destapaciones y Plomerías 24hs | CABA y GBA | DestapacionesPlomero.com",
    description:
      "🔧 Servicio profesional de destapaciones y plomería las 24 horas en CABA y Gran Buenos Aires. Equipos especializados, garantía de trabajo.",
    images: [
      {
        url: "/logo-destapaciones.webp",
        width: 1200,
        height: 630,
        alt: "Destapaciones y Plomerías - Servicio Profesional 24hs",
      },
    ],
  },
  alternates: {
